...
namespace Gfi.Hiring {
    internal class PieceFactory_Tests {
        ...
        {
            IChessPiece piece = _pieceFactory.CreatePiece(PieceType.Pawn, PieceColor.Black);
        ...
        {
            IChessPiece piece = _pieceFactory.CreatePiece(PieceType.Pawn, PieceColor.White);
